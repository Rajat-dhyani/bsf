...
public class PersonalInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jIdCardno.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jIdCardnoKeyPressed(evt);
            }
        });
...
INSERT INTO "main"."PersonalInformation" SELECT "RegimentalNo","First Name","Middle Name","Last Name","PAN","Rank ","SEX","Phone No ","Blood Group ","PRAN No ","Bank Acount No ","ID Card No","Adhar No ","Driving License","Date Of Birth ","Govt. Serv. ","Battalion 
        */
        try{
            String st = "Insert into PersonalInformation (RegimentalNo,First_Name,Middle_Name,Last_Name,PAN,Rank,SEX,Phone_No,Blood_Group,PRAN_NO,Bank_Account_No,ID_Card_No,Adhar_No,Driving_License,Date_Of_Birth,Govt_Serv,Battalion) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            if (jCSEX.getSelectedItem() != null)
              ps.setString(7, jCSEX.getSelectedItem().toString());
            if (!jTPhoneNo.getText().equals(""))
                ps.setInt(8, Integer.parseInt(jTPhoneNo.getText()));
            ps.setString(9,jTPranNo.getText());
            ps.setString(10, jTBankAccountNo.getText());
            if (!jIdCardno.getText().equals(""))
                ps.setInt(11, Integer.parseInt(jIdCardno.getText()));
            ps.setString(12, jTAdharNo.getText());
            if (jCDrivingLicense.getSelectedItem() != null)
            ps.setString(13, jCDrivingLicense.getSelectedItem().toString());
             ps.setDate(14,DBMS.convertUtilDateToSqlDate(jDDateOfBirth.getDate()));
            
             ps.setDate(15,DBMS.convertUtilDateToSqlDate(jDGovtServ.getDate()));
             ps.setDate(16,DBMS.convertUtilDateToSqlDate( jDBattalion.getDate()));
            ...
            ps.setInt(1, Integer.parseInt(jTRegimentalNo.getText()));
             ...
             ps.setDate(2,DBMS.convertUtilDateToSqlDate( jDELFrom1.getDate()));
           
             ps.setDate(3,DBMS.convertUtilDateToSqlDate( jDELTo1.getDate()));
           
             if ( !(jLEarn1.getText().equals("total")))
             ps.setInt(4,Integer.parseInt(jLEarn1.getText()));
           
             ps.setDate(5,DBMS.convertUtilDateToSqlDate(jDELFrom2.getDate()));
           
                ps.setDate(6,DBMS.convertUtilDateToSqlDate(jDELTo2.getDate()));
            
             if (!(jLEarn2.getText().equals("total")))
             ps.setInt(7,Integer.parseInt(jLEarn2.getText()));
           
             ps.setDate(8,DBMS.convertUtilDateToSqlDate(jDELFrom3.getDate()));
            
             ps.setDate(9,DBMS.convertUtilDateToSqlDate(jDELTo3.getDate()));
          
             if (jLEarn3.getText() != null && !(jLEarn3.getText().equals("total")))
             ps.setInt(10,Integer.parseInt(jLEarn3.getText()));
           
             ps.setDate(11,DBMS.convertUtilDateToSqlDate(jDCLFrom1.getDate()));
            
             ps.setDate(12,DBMS.convertUtilDateToSqlDate(jDCLTO1.getDate()));
           
             if ( !(jLCLNoOFDays1.getText().equals("total")))
                ps.setInt(13,Integer.parseInt(jLCLNoOFDays1.getText()));
            
              ps.setDate(14,DBMS.convertUtilDateToSqlDate(jDCLFrom2.getDate()));
            
              ps.setDate(15,DBMS.convertUtilDateToSqlDate(jDCLTO2.getDate()));
            
              if ( !(jLCLNoOFDays2.getText().equals("total")))
                  ps.setInt(16,Integer.parseInt(jLCLNoOFDays2.getText()));
            
              ps.setDate(17,DBMS.convertUtilDateToSqlDate(jDCLFrom3.getDate()));
            
                ps.setDate(18,DBMS.convertUtilDateToSqlDate(jDELTo3.getDate()));
            
            if ( !(jLCLNoOFDays3.getText().equals("total")))
             ps.setInt(19,Integer.parseInt(jLCLNoOFDays3.getText()));
          
            if ( !(jLTotal.getText().equals("total")))
    ...
    private void jTFirstNameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFirstNameKeyTyped
        ...
        if((key >= KeyEvent.VK_0 && key <= KeyEvent.VK_9)|| key == KeyEvent.VK_SPACE)
    ...
    private void jTFirstNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFirstNameKeyPressed
        ...
        if((key >= KeyEvent.VK_0 && key <= KeyEvent.VK_9)||( key >= KeyEvent.VK_NUMPAD0 && key <= KeyEvent.VK_NUMPAD9 )|| key == KeyEvent.VK_SPACE && key != KeyEvent.VK_BACK_SPACE )
            JOptionPane.showMessageDialog(null,"DIGITS/WIDE SPACE not Allowed");
    ...
    private void jIdCardnoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jIdCardnoKeyPressed
        // TODO add your handling code here:
         int key = evt.getKeyCode();
        
        if( !( key >= KeyEvent.VK_0 && key <= KeyEvent.VK_9 )&& !( key >= KeyEvent.VK_NUMPAD0 && key <= KeyEvent.VK_NUMPAD9 ) && key != KeyEvent.VK_BACK_SPACE)
            JOptionPane.showMessageDialog(null,"Please Enter 10 digits No.");
    }//GEN-LAST:event_jIdCardnoKeyPressed
