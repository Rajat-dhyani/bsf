...
public class DBMS {
  ...
  public static void excessConvertor(String name1,String name2,String name3,String name4,String name5,String path)
    {     
        ...
        try
        {
                ...
                Sheet sheet1 = workbook.createSheet(name1);
                Sheet sheet2 = workbook.createSheet(name2);
                Sheet sheet3 = workbook.createSheet(name3);
                Sheet sheet4 = workbook.createSheet(name4);
                Sheet sheet5 = workbook.createSheet(name5);
               
                i = 0 ;
                Row row = sheet1.createRow(0);
                    
                for (String str : getTableHeader(info.personalInfo))
                {
                ...
                j=0;
                i = 1;
                for ( String rows[] : getTable(info.personalInfo))
                {
                ...
                for (String str : getTableHeader(info.leaveDetails))
                {
                    Cell cell = row.createCell(j);
                    cell.setCellValue(str);
                    j++;
                ...
                j=0;
                i = 1;
                for ( String rows[] : getTable(info.leaveDetails))
                {
                ...
                for (String str : getTableHeader(info.runningDetails))
                {
                    Cell cell = row.createCell(j);
                    cell.setCellValue(str);
                    j++;
                ...
                j=0;
                i = 1;
                for ( String rows[] : getTable(info.runningDetails))
                {
                ...
                for (String str : getTableHeader(info.familyInfo))
                {
                    Cell cell = row.createCell(j);
                    cell.setCellValue(str);
                    j++;
                ...
                j=0;
                i = 1;
                for ( String rows[] : getTable(info.familyInfo))
                {
                ...
                for (String str : getTableHeader(info.courseDetails))
                {
                    Cell cell = row.createCell(j);
                    cell.setCellValue(str);
                    j++;
                ...
                j=0;
                i = 1;
                for ( String rows[] : getTable(info.courseDetails))
                {
